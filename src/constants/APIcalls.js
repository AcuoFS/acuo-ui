...
export const OPTIMISATION_URL         = 'http://qa.acuo.com:8081/pledge/optimization'
export const COLLATERAL_URL           = 'http://qa.acuo.com:8081/pledge/init-new-collateral'
export const MARGIN_SELECTION_URL     = 'http://qa.acuo.com:8081/pledge/init-selection'
export const ALLOCATE_COLLATERALS_URL = 'http://qa.acuo.com:8081/pledge/allocate-selection'
export const ALLOCATE_COLLATERALS_URL_NEW = 'http://qa.acuo.com:8081/pledge/allocate-selection-new'
export const PLEDGE_ALLOCATIONS = 'http://qa.acuo.com:8081/pledge/pledge-allocation'
