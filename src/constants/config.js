var configJson = {
  ...
  MARGIN_HEALTH_CHECK: 'http://localhost:8081/common/margin-connectivity',
  VALUATION_HEALTH_CHECK: 'http://localhost:8081/common/valuation-connectivity',
  COLLATERAL_HEALTH_CHECK: 'http://localhost:8081/common/collateral-connectivity',
